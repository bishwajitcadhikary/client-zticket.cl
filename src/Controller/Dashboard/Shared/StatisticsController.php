...
class StatisticsController extends Controller {
    ...
    /**
     * @Route("/administrator/manage-events/{eventSlug}/event-dates/{eventDateReference}/reserved-seats", name="dashboard_administrator_event_date_reservedSeats")
     * @Route("/organizer/my-events/{eventSlug}/event-dates/{eventDateReference}/reserved-seats", name="dashboard_organizer_event_date_reservedSeats")
     */
    public function eventDateReservedSeats($eventDateReference, Request $request, TranslatorInterface $translator, AppServices $services) {
        ...
        return $this->render('Dashboard/Shared/Statistics/reserved-seats.html.twig', [
                    'eventDate' => $eventDate,
        ]);
    }
}
